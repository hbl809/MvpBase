...
public class TabCollectionFragment extends BaseMvpFragment<MainPresenter> implements MainContract.View  {
    ...
    public static TabCollectionFragment newInstance(String param1) {
